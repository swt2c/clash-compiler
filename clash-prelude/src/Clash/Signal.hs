...
__NB__: The component given to 'andEnable' as an argument needs an explicit type
signature. Please read [Monomorphism restriction leads to surprising
...
__NB__: The component given to 'andSpecificEnable' as an argument needs an
explicit type signature. Please read [Monomorphism restriction leads to
